...
> ### 《御制数理精蕴》：万进
> 凡度量衡，自单位以上则曰：十、百、千、万、亿、兆、京、垓、秭、穰、沟、涧、正、载、极、恒河沙、阿僧秪、那由他、不可思议、无量数。自亿以上，有以十进者，如十万曰亿，十亿曰兆之类；有以万进者，如万万曰亿，万亿曰兆之类；有以自乘之数进者，如万万曰亿，亿亿曰兆之类。今立法从中数。

### *圣经原典 —WarmCheese 2020*
```c
